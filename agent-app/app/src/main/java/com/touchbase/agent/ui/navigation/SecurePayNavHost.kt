...
import com.touchbase.agent.ui.ledger.CustomerPaymentsScreen
    ...
    NavHost(
        ...
        composable(Screen.Ledger.route) {
            LedgerScreen(
                ...
                onNavigateToInventory = { navigateToTab(Screen.Inventory.route) },
                onNavigateToMore = { navigateToTab(Screen.More.route) },
                onNavigateToCustomerPayments = { accountId ->
                    navController.navigate(Screen.CustomerPayments.createRoute(accountId))
                }
            )
        }
