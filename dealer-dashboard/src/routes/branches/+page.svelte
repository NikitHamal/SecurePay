...
<div class="page">
  ...
  <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    <div class="flex flex-wrap items-center gap-3 text-xs text-ink-secondary">
      <div>Total Branches: <strong class="font-semibold text-ink-primary">{branches.length}</strong></div>
      <span class="text-ink-muted/40">•</span>
      <div>Agencies Represented: <strong class="font-semibold text-ink-primary">{uniqueAgencies}</strong></div>
      <span class="text-ink-muted/40">•</span>
      <div>Total Agents: <strong class="font-semibold text-ink-primary">{totalAgents}</strong></div>
    </div>
