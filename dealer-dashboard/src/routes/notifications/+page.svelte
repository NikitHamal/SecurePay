<script lang="ts">
  ...
  function getIcon(type: string): string {
    switch (type) {
      ...
      case 'DEFAULT_ALERT': return 'M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z';
      case 'APPLICATION_APPROVED': return 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z';
  ...
  function getIconColor(type: string): string {
    switch (type) {
      ...
      case 'PAYMENT_RECEIVED': return 'text-emerald';
      case 'DEFAULT_ALERT': return 'text-crimson';
      case 'APPLICATION_APPROVED': return 'text-emerald';
